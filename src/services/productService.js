...
class ProductService {
  ...
  async updateComment(productId, commentId, comment) {
    ...
    const foundedComment = product.comments.find(comment => comment._id == commentId);
  ...
  async deleteComment(productId, commentId) {
    ...
    const foundedCommentIndex = product.comments.findIndex(comment => comment._id == commentId);
